      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-2 no-padding">
		  	<div class="tabs tab-orange">Performance</div>
		  </div>
		   <div class="col-xs-2 no-padding">
		   	<div class="tabs"><g:link controller="hqa" action="index" class="pageload-link">Surveys</g:link ></div>
		   </div>
          <div class="col-xs-5">
            <div class="my-profile">
              <g:if test="${currentStudent != null}">
                ...
                <ul role="menu" class="dropdown-menu">
                    <li><g:link controller="index" action="index">Dashboard</g:link></li>
                    <sec:ifAllGranted roles='ROLE_ADMIN'>
                    <li><g:link controller="index" action="maintenance">Maintenance</g:link></li>
                    </sec:ifAllGranted>
