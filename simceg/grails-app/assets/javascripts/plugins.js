...
(function($) {
  ...
  $.bsmSelect.conf = {
    ...
    title: 'Selecciona...',                         // Text used for the default select label
    removeLabel: 'borrar',                      // HTML used for the 'remove' link
    highlightAddedLabel: 'Agregí: ',             // Text that precedes highlight of added item
    highlightRemovedLabel: 'Removió: ',         // Text that precedes highlight of removed item
