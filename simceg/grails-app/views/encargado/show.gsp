	...
	<body>
		...
		<div id="show-encargado" class="content scaffold-show" role="main">
			...
			<ol class="property-list encargado">
				...
				<g:if test="${encargadoInstance?.usuario}">
				<li class="fieldcontain">
					<span id="usuario-label" class="property-label"><g:message code="encargado.usuario.label" default="Usuario" /></span>
					
						<span class="property-value" aria-labelledby="usuario-label"><g:link controller="usuario" action="show" id="${encargadoInstance?.usuario?.id}">${encargadoInstance?.usuario?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${encargadoInstance?.viviAlumno}">
				<li class="fieldcontain">
					<span id="viviAlumno-label" class="property-label"><g:message code="encargado.viviAlumno.label" default="Vivi Alumno" /></span>
					
						<span class="property-value" aria-labelledby="viviAlumno-label"><g:formatBoolean boolean="${encargadoInstance?.viviAlumno}" /></span>
